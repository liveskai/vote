...
global const string CANT_KICK_ADMIN = "您不能移出管理员"
...
// help
global const string HELP_MESSAGE = "欢迎来到超好玩的服务器\nQQ群456665285\n在聊天框输入 !help 获取帮助"
...
global const string BALANCED_TITANDAMAGE = "队伍已由 每条命的平均泰坦伤害 进行了再分配"
